  ...
  return (
    <div>
      <div className='donate-container'>
        ...
        <div className='donate-text-container'>
          <div className='donate-text'>
            <h1><Link to='/paypal' className='donate-link' target='_blank'>DONATE</Link> through<br />Paypal Giving Fund</h1>
            <p>
              <Link to='/paypal' className='donate-link' target='_blank'>CLICK HERE TO DONATE!!</Link><br />
      ...
      <div className='donate-container amazon'>
        ...
        <div className='donate-text-container'>
          <div className='donate-text'>
            <h1><Link to='/amazon' className='donate-link' target='_blank'>DONATE</Link> through<br />AmazonSmile</h1>
            ...
            <p>
              ...
              Support us by starting your shopping at <Link to='/amazon' className='donate-link' target='_blank'>smile.amazon.com</Link>.
            </p>
          </div>
        </div>
      </div>
